...
export class Pokedex implements PokedexData {
  ...
  listarPorAtributo(atributo: keyof PokeData, ascendente: boolean = true): PokeData[] {
  ...
  filtrarPorAtributo<T extends keyof PokeData>(atributo: T, valor: PokeData[T]): PokeData[] {
